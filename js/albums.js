...
window.ALBUMS = {
  ...
  iphone: {
    ...
    photos: [
      ...
      { src: 'assets/img/shotoniphone2.webp',  cap: 'a quiet frame, found by accident', l: 'tall' },
      { src: 'assets/img/shotoniphone.webp', cap: 'somewhere between here and there', l: 'wide' },
      { src: 'assets/img/shotoniphone3.webp', cap: 'the city, briefly still', l: 'full' },
      { src: 'assets/img/shotoniphone4.webp', cap: 'last light before the door closes', l: 'std' },
    ],
  },
};
